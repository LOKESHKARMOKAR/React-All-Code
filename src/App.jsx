    ...
    <div className='min-h-screen bg-[#3b3b98] flex justify-center items-center'>
      <div className='w-80'>
        <div className='bg-[#23235b] rounded shadow-lg p-5'>
          <h2 className='text-center text-white mb-5 font-extrabold '>Password Generator</h2>
          ...
          <button
            ...
            className='bg-[#3b3b98] text-white w-full p-2 text-lg cursor-pointer hover:bg-black hover:font-bold'
          >
            Generate Password
          </button>
